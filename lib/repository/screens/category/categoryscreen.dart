          ...
          children: filters.map((filter) {
            ...
            return Padding(
              ...
              child: ChoiceChip(
                label: Text(filter),
                selected: isSelected,
                selectedColor: const Color(0xFF221662),
  ...
  Widget _buildBottomSheetDetails(Map<String, String> product) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(product['weight']!, style: TextStyle(color: Colors.grey[600])),
        const SizedBox(height: 8),
        Text("Sold by : ${product['seller']}", style: TextStyle(color: Colors.grey[700], fontSize: 13)),
      ],
    );
  }
