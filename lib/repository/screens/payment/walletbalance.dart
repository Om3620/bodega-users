...
class BOdegaWalletBalanceScreen extends StatelessWidget {
  const BOdegaWalletBalanceScreen({super.key});
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          ...
                          pageBuilder: (context, animation, secondaryAnimation) => WalletPaymentScreen(),
                          transitionsBuilder: (context, animation, secondaryAnimation, child) {
